---
title: "Job Ads density in VA GO Region 7"
...
job_Reg1 <- treemap(data_jobs_va_region %>% dplyr::filter(va_region == 7) ,
...
# Distribution of salaries in VA GO Region 7
...
salary_Reg7 <- ggplot(data_jobs_va_region %>% filter(va_region== 7, !is.na(occfamname_corr)), aes(x = salary, y = occfamname_corr, fill = ..x..)) +
