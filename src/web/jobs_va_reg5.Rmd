---
title: "Job Ads density in VA GO Region 5"
...
job_Reg1 <- treemap(data_jobs_va_region %>% dplyr::filter(va_region == 5) ,
...
# Distribution of salaries in VA GO Region 5
...
salary_Reg5 <- ggplot(data_jobs_va_region %>% filter(va_region== 5, !is.na(occfamname_corr)), aes(x = salary, y = occfamname_corr, fill = ..x..)) +
