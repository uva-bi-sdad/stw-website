---
title: "Job Ads density in VA GO Region 4"
...
job_Reg1 <- treemap(data_jobs_va_region %>% dplyr::filter(va_region == 4) ,
...
salary_Reg4 <- ggplot(data_jobs_va_region %>% filter(va_region== 1, !is.na(occfamname_corr)), aes(x = salary, y = occfamname_corr, fill = ..x..)) +
