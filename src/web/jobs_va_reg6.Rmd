---
title: "Job Ads density in VA GO Region 6"
...
salary_Reg6 <- ggplot(data_jobs_va_region %>% filter(va_region== 1, !is.na(occfamname_corr)), aes(x = salary, y = occfamname_corr, fill = ..x..)) +
