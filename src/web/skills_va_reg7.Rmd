---
title: "Skill Taxonomy Density in VA GO Region 7"
...
Reg7 <- treemap(data_skills_scf_sc_s_va_region %>% dplyr::filter(va_region == 7) ,
...
d3tree2( Reg7 ,  rootname = "Skill taxonomy" )
