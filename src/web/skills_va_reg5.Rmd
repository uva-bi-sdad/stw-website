---
title: "Skill Taxonomy Density in VA GO Region 5"
...
Reg5 <- treemap(data_skills_scf_sc_s_va_region %>% dplyr::filter(va_region == 5) ,
...
d3tree2( Reg5 ,  rootname = "Skill taxonomy" )
