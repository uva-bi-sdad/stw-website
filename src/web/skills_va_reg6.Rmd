---
title: "Skill Taxonomy Density in VA GO Region 6"
...
Reg6 <- treemap(data_skills_scf_sc_s_va_region %>% dplyr::filter(va_region == 6) ,
...
d3tree2( Reg6 ,  rootname = "Skill taxonomy" )
