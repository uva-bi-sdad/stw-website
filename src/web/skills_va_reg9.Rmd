---
title: "Skill Taxonomy Density in VA GO Region 9"
...
Reg9 <- treemap(data_skills_scf_sc_s_va_region %>% dplyr::filter(va_region == 9) ,
...
d3tree2( Reg9 ,  rootname = "Skill taxonomy" )
