---
title: "Skill Taxonomy Density in VA GO Region 2"
...
Reg2 <- treemap(data_skills_scf_sc_s_va_region %>% dplyr::filter(va_region == 2) ,
...
d3tree2( Reg2 ,  rootname = "Skill taxonomy" )
