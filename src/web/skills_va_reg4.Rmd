---
title: "Skill Taxonomy Density in VA GO Region 4"
...
Reg4 <- treemap(data_skills_scf_sc_s_va_region %>% dplyr::filter(va_region == 4) ,
...
d3tree2( Reg4 ,  rootname = "Skill taxonomy" )
