...
# Distribution of salaries in VA GO Region 2
...
salary_Reg2 <- ggplot(data_jobs_va_region %>% filter(va_region== 2, !is.na(occfamname_corr)), aes(x = salary, y = occfamname_corr, fill = ..x..)) +
