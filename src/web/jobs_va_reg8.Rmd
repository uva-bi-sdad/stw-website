---
title: "Job-ad Density in VA GO Region 8"
...
# Distribution of Salaries in VA GO Region 8
...
salary_Reg8 <- ggplot(data_jobs_va_region %>% filter(va_region== 8, !is.na(occfamname_corr)), aes(x = salary, y = occfamname_corr, fill = ..x..)) +
