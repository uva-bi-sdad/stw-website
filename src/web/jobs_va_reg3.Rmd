---
title: "Job Ads density in VA GO Region 3"
...
job_Reg1 <- treemap(data_jobs_va_region %>% dplyr::filter(va_region == 3) ,
...
salary_Reg3 <- ggplot(data_jobs_va_region %>% filter(va_region== 3, !is.na(occfamname_corr)), aes(x = salary, y = occfamname_corr, fill = ..x..)) +
