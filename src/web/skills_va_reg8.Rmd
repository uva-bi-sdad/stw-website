---
title: "Skill Taxonomy Density in VA GO Region 8"
...
Reg8 <- treemap(data_skills_scf_sc_s_va_region %>% dplyr::filter(va_region == 8) ,
...
d3tree2( Reg8 ,  rootname = "Skill taxonomy" )
